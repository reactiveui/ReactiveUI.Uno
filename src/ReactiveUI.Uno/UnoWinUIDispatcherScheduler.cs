...
/// </summary>
public partial class UnoWinUIDispatcherScheduler : LocalScheduler, ISchedulerPeriodic, ISequencer
{
    /// <summary>
    ...
    public void Schedule(IWorkItem item)
    {
        ...
        Schedule(item, static (_, workItem) =>
        {
            workItem.Execute();
    ...
    public void Schedule(IWorkItem item, long dueTimestamp)
    {
        ...
        Schedule(item, dueTime, static (_, workItem) =>
        {
            workItem.Execute();
            return Disposable.Empty;
        });
