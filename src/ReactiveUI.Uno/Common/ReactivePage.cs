...
/// To use <see cref="ReactivePage{TViewModel}"/> in XAML documents you need to create
/// a base class where you derive from <see cref="ReactivePage{TViewModel}"/> with the type argument filled in.
/// <code>
/// <![CDATA[
