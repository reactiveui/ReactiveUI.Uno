...
{
    /// <summary>Asynchronously initializes the database connection, optionally using the specified database file path.</summary>
    ...
    /// <summary>Ensures that the sample data is present in the underlying data store, creating it if necessary.</summary>
    ...
    /// <summary>Executes the specified SQL query asynchronously and returns the result set as a read-only list of objects.</summary>
